namespace E_Shop.Data.Identity
{
    ...
    /// <summary>
    ///     A way to send messages via SMS
    /// </summary>
    ...
    /// <summary>
    /// Sms sender for Nixelt.Store using SMSC.UA API (smsc.ua) version 3.0 (31.01.2017)
    /// </summary>
    public class SmscSender : ISmsSender
    {
        private const string SmscLogin = "maxivanovpr";
        private const string SmscPassword = "ApiPassword0307";
